        ...
        <div class="max-w-4xl mx-auto mt-6 space-y-6">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-gray-400">
                            {{ __('Data utama posisi yang ditawarkan') }}
                        </p>
                    </div>
                    <span
                ...
                <div class="p-6 space-y-5">
                    {{-- Nama Pekerjaan --}}
                    <div>
                        <x-core::input label="{{ __('Nama / Posisi Pekerjaan') }}" name="nama_pekerjaan"
                            wire:model="nama_pekerjaan" x-model="nama_pekerjaan"
                        ...
                        <p class="mt-1.5 text-[11px] text-gray-400 dark:text-gray-500">
                            {{ __('Nama posisi yang jelas membantu kandidat lebih mudah menemukan lowongan ini.') }}
                        </p>
                    </div>

                    {{-- Slug --}}
                    <div>
                        <x-core::input label="{{ __('Slug URL') }}" name="slug" wire:model="slug" x-model="slug"
                            x-slug="combinedTitle" required />
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-[11px] text-gray-400 dark:text-gray-500">
                            {{ __('Menampilkan kisaran gaji meningkatkan jumlah pelamar yang relevan.') }}
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <x-core::input type="date" label="{{ __('Tanggal Berakhir Lowongan') }}" name="tgl_berakhir"
                                onclick="this.showPicker()" wire:model="tgl_berakhir" />
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-gray-400">
                            {{ __('Profil dan kontak perusahaan pemberi kerja') }}
                        </p>
                    </div>
                    <span
                ...
                <div class="p-6 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <x-core::select-dropdown :label="__('Nama Perusahaan')" :items="$companyOptions"
                                model="nama_perusahaan" labelField="name" valueField="name" />
                            <input type="hidden" name="nama_perusahaan" x-model="$wire.nama_perusahaan">
                            <x-core::input-error for="nama_perusahaan" />
                        </div>
                        <div>
                            <x-core::input label="{{ __('Website Perusahaan Untuk Apply Lowongan') }}"
                                name="url_perusahaan" wire:model="url_perusahaan"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <x-core::input label="{{ __('Alamat Lengkap') }}" name="alamat_perusahaan"
                                wire:model="alamat_perusahaan" placeholder="{{ __('Jl. Contoh No. 1, Kecamatan…') }}" />
                            <x-core::input-error for="alamat_perusahaan" />
                        </div>
                    </div>

                    <div>
                        <x-core::textarea label="{{ __('Tentang Perusahaan') }}" name="deskripsi_perusahaan"
                            wire:model="deskripsi_perusahaan" rows="3"
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-gray-400">
                            {{ __('Deskripsi tugas dan cara melamar') }}
                        </p>
                    </div>
                    <span
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <x-core::textarea label="{{ __('Deskripsi Pekerjaan') }}" name="deskripsi_pekerjaan"
                            wire:model="deskripsi_pekerjaan" rows="5"
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <x-core::textarea name="apply" wire:model="apply" rows="3"
                                placeholder="{{ __('Contoh: Kirim CV dan portofolio ke hr@perusahaan.com dengan subjek \'Nama – Posisi\'') }}" />
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-gray-900 dark:text-white">
                            {{ __('Persyaratan & Kualifikasi') }}
                        </h3>
                        <p class="text-[11px] text-gray-500 dark:text-gray-400">
                            {{ __('Gunakan heading, poin, atau tabel sesuai kebutuhan') }}
                        </p>
                    </div>
                    <span
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-gray-400">
                            {{ __('Visibilitas lowongan di halaman publik') }}
                        </p>
                    </div>
                    <span
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ __('Publikasikan Lowongan') }}
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                    {{ __('Aktifkan agar lowongan tampil di halaman publik dan dapat dilamar.') }}
                                </p>
                            </div>
                        </div>
                        <div class="relative inline-block w-12 h-6 shrink-0 ml-4">
                            <input type="checkbox" id="active-toggle" name="actived" value="1" wire:model="actived"
                                class="peer sr-only" />
                            <span
                ...
                <div
                    ...
                    <div class="hidden sm:block">
                        <p class="text-xs font-semibold text-gray-700 dark:text-gray-300">
                            {{ $lokerId ? __('Perbarui') : __('Simpan') }} {{ __('semua perubahan') }}
                        </p>
                        <p class="text-[11px] text-gray-400 dark:text-gray-500">
                            {{ __('Pastikan semua bagian telah terisi sebelum menyimpan.') }}
                        </p>
                    </div>
